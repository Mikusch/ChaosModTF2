...
const FFADE_OUT = 0x0002
const FFADE_MODULATE = 0x0004
const FFADE_STAYOUT = 0x0008
...
CONST.MASK_PLAYERSOLID_BRUSHONLY <- (CONST.MASK_SOLID_BRUSHONLY | CONTENTS_PLAYERCLIP)
